...
class LevelEditor:
    ...
    """
    def __init__(self, screen, grid_size, grid_color, obstacle_sprites):
        self.screen = screen
        self.grid_size = grid_size
        self.grid_color = grid_color
        self.obstacle_sprites = {
            tool: pygame.transform.scale(sprite, (grid_size, grid_size))
            for tool, sprite in obstacle_sprites.items()
        }
        self.level_data = []
